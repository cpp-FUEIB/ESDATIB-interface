...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Busca en el catalogo federado" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "PageHeader", PageHeader, { "title": "Busca en el catalogo federado" })} ${renderComponent($$result2, "SearchTabs", null, { "client:only": "vue", "search": search, "client:component-hydration": "only", "client:component-path": "/app/src/components/search/SearchTabs.vue", "client:component-export": "default" })} ` })}`;
